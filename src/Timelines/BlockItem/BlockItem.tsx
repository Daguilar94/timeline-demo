...
export default function BlockItem({getItemProps, item, itemContext}: BlockItemProps) {
  return (
    <div
      {...getItemProps({
        className: classNames({[styles.blockItem]: !item.isPlainText, [styles.singleItem]: item.isPlainText}),
        onMouseDown: () => {
